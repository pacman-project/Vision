...
function [] = singleTestImage(testFileName, vocabulary, distanceMatrices, categoryName, optimalThresholds, vocabUpdatedLabels, options)
...
%    imwrite(smoothedImg, [options.smoothedFolder '/' fileName '.png']);
    ...
    [exportArr, activationArr] = inferSubs(vocabulary, nodes, nodeActivations, distanceMatrices, optimalThresholds, vocabUpdatedLabels, options); %#ok<ASGLU,NASGU>
