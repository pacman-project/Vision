...
classdef GraphNode
    properties
        labelId@uint32 % Label id of the part the realization belongs to.
        imageId@uint32 % Image id of the realization. It can be used as the index 
                % in trainingFileNames array to get the name of the image.
        position@uint32 % Position of the part's center in terms of image pixels. 
                 % Top left is (1,1).
        children@uint32 % The children of this node in the previous level of 
                 % mainGraph(object graphs). They link to realization ids,
                 % which are indices of GraphNodes in respective mainGraph
                 % level.
        parents@uint32  % The parents of this node in the next level of mainGraph 
                 % (object graphs). Links to realization ids.
        adjInfo@uint32 % Different than VocabNode, this field encodes relations of 
        ...
        leafNodes@uint32 % The leaf node ids (level 1 realizations) this node 
