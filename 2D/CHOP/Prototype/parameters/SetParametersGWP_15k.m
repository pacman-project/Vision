...
function [ options ] = SetParametersGWP_15k( datasetName, options )
...
%    options.gabor.sigma = 2.5;            % Gabor filter parameters
 %   options.gabor.sigma = 1.21;    
    ...
    options.reconstruction.numberOfORNodes = [100 120 250 500 750 1500 1500 1500 1500 1500 1500 1500 1500 1500]; % The maximum 
                                           % number of reconstructive parts
                                           % that can be selected.
