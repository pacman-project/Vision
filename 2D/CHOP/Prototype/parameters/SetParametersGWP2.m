...
function [ options ] = SetParametersGWP2( datasetName, options )
    ...
    options.matlabRestartImageCount = 20000; % If we have more than this number 
...
%    options.gabor.sigma = 2.5;            % Gabor filter parameters
    ...
    options.minEdgeNoveltyThr = 0.2;    % Minimum edge novelty threshold.
    options.edgeNoveltyThrRate = 0.125;   % The edge novelty threshold 
