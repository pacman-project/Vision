...
function [ options ] = SetParametersYaleFaces( datasetName, options )
    ...
    options.auto.stride = 10;                % Stride to use when extracting first-
...
%    options.maxImageDim = options.gaborFilterSize*40;
    ...
    options.subdue.threshold = 0.07; % Theshold for elasticity-based matching 
