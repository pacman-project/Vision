...
%>
%> Description: Parameters for Swans dataset (ETHZ). 
%>
...
function [ options ] = SetParametersSwans( datasetName, options )
    ...
    options.maxImageDim = floor(options.receptiveFieldSize*8);
