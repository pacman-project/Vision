...
function [ options ] = SetParametersCALTECH101_small( datasetName, options )
    ...
    options.subdue.minThreshold = 0.10; % Minimum threshold for elastic matching.
    options.subdue.maxThreshold = 0.20; % Max threshold for elastic part matching. 
