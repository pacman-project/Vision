...
function [bestSubs, optimalThreshold, optimalAccuracy] = selectParts(bestSubs, realNodeLabels, realEdgeLabels, ...
    nodeDistanceMatrix, edgeDistanceMatrix, nodePositions, edgeCoords, allEdges, allEdgeProbs, ...
    singlePrecision, stoppingCoverage, numberOfFinalSubs, fixedThreshold, ...
    ...
    for valItr = 1:validationFolds
        ...
        if supervisionFlag
           ...
           [validSubs, ~, ~] = getReconstructiveParts(bestSubs, realNodeLabels, ...
                realEdgeLabels, nodePositions, edgeCoords, allEdges, allEdgeProbs, ...
                optimalCount, stoppingCoverage, remainingChildren);
        end
