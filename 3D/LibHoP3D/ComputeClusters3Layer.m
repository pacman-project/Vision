% this is to compute clusters (mu and sigmas) of the third layer

clear all;

stats = load('statistics/statistics5D_3layer_19_6000.mat');
...
save('statistics/pairs3layer_8.mat','cluster3stats');
