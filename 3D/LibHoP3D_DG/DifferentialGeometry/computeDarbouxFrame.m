...
function [V, values] = computeDarbouxFrame(Norm, xs, ys, zs, curvThresh)  % dx, dy,
...
%     Norm = Norm/norm(Norm);
    ...
    %%   CORRECT, BUT QUITE SLOW IMPLEMENTATION
%     for ii = 2:numPoints
% 
%         vj = [0,0,0]';
...
%         angles(i) = atan2(sinT, cosT);
    ...
    % these angle may be needed for additional computations
