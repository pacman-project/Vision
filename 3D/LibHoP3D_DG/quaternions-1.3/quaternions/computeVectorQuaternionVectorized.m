% compute quaternions for rotating X to Z

function quat = computeVectorQuaternionVectorized(X, Z)
...
%     end
    ...
    if length(QNorm(QNorm == 0)) > 0
        disp('Error in ComputeVectorQuaternionVectorized!!!!!!!!!!!!! DIVISION BY ZERO!!!');
    end
