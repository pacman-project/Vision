...
function [cluster1Centres, cluster1Bounds, thresh] = learnFirstLayerMesh(list_depth, nClusters, quantilesFirst)
    ...
    [allDXs, lenX] = computeFirstLayerDistributionMesh(list_depth);
