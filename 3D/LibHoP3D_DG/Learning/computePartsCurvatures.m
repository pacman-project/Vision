% this function computes curvatures of the vie-winvariant parts

function D = computePartsCurvature(partsOut, layerID, pairsLeft, pairsRight, rad, isGPU)
   ...
   disp('Computing curvatures of parts...');
