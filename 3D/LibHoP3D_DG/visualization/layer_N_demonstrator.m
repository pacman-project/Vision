...
function [is_ok] = layer_N_demonstrator(layerID, tripleOutDepth, offsetsConventional, ...
    ...
    for j = 1:nNClusters  % for each 6th layer element
        ...
        %  (layerID, partID, fieldCenter, tripleOutDepth, offsetsConventional, depthStep, nClusters)
                                                       
        
        surfaceVisualizerT(fieldSize, positions, elements, elementRadius, nClusters, cluster1Centres, depthStep);
