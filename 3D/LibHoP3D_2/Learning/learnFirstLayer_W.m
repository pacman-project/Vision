...
function [cluster1Centres, cluster1Lengths, thresh] = learnFirstLayer(list_depth, list_mask, sigma, sigmaKernelSize, dxKernel, nClusters, ...
                                                                        is_downsampling, dowsample_rate, quantilesFirst, dataSetNumber)
    ...
    elseif dataSetNumber == 2
        [allDXs, lenX] = computeFirstLayerDistribution_W(list_depth, list_mask, sigma, sigmaKernelSize, dxKernel, is_downsampling, dowsample_rate);
    end
