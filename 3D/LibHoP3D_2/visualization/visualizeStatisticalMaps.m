function [] = visualizeStatisticalMaps( layerID, tripleOutDepth, displ3, displ5, displ7, ...
    ...
    for jjj = 1:nNClusters% for each 6th layer element
        ...
        [positions, elements] = partMeanReconstruction(layerID, jjj, fieldCenter, tripleOutDepth, displ3, displ5, displ7, nClusters);
...
%             % now visualize the other part
            [positionsAdd, elementsAdd] = partMeanReconstruction(layerID, jj, fieldCenter, tripleOutDepth, displ3, displ5, displ7, nClusters);
