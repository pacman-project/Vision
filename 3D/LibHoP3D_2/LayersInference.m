...
elseif dataSetNumber == 2
    depthPath = [commonRoot,'Input Data/Washington/Wash-rgbd-dataset_001'];      % '/home/vvk201/Wash-rgbd-dataset_0003T' 
...
is_inhibition_first_layer = true;
is_inhibition_second_layer = true; 
...
isReconstructionErrorRequired = [is_reconstructionError_first_layer, is_reconstructionError_second_layer, is_reconstructionError_third_layer, ...
    is_reconstructionError_4th_layer, is_reconstructionError_5th_layer, is_reconstructionError_6th_layer];
...
if is_first_layer || is_second_layer 
    ...
    load(vocabulary1Layer); % should contain: cluster1Centres, cluster1Bounds, thresh
...
if is_third_layer 
    ...
    performInference3(list_depth, list_El, list_mask, lenF, sigma, sigmaKernelSize, dxKernel, nClusters, n2Clusters, n3Clusters, X, triples3Out, coverageOut, displacement34, abstractionLevel, ...
...
if is_4th_layer 
    ...
    meargeThresh = sqrt(4) - 0.01;
    depthStep = thresh/4;
    
    performInference4(list_depth, list_El, list_mask, lenF, sigma, sigmaKernelSize, dxKernel, nClusters, n2Clusters, ...
...
if is_5th_layer 
    ...
    performInferenceNext(list_depth, list_El, list_mask, lenF, sigma, sigmaKernelSize, dxKernel, ...
                n4Clusters, n5Clusters, X, triples5Out, coverageOut, displ3, displ5, displ7, abstractionLevel,  ...
